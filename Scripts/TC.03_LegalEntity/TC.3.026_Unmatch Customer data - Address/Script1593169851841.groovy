...
WebUI.setText(findTestObject('TC.02_Personal/txtLeadsName'), 'Basirun')
...
WebUI.click(findTestObject('TC.02_Personal/Detail/Document Checklist/data/divAddress'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Address/chkUnmatchAddress'))

WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Address/chkUnmatchRTRW'))

WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Address/chkUnmatchCountry'))

WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Address/chkUnmatchZipCode'))

WebUI.setText(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Address/txtAddress'), 'Jl Anggrek')

WebUI.setText(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Address/txtRT'), '001')

WebUI.setText(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Address/txtRW'), '012')

WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Address/ddlCountry'))

WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Address/ddlCountryItem_Indonesia'))

WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Address/ddlProvince'))

WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Address/ddlProvinceItem_SUMATERA UTARA'))

WebUI.comment('Popup ZipCode')

WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Address/btnPopUpZipCode'))
...
WebUI.setText(findTestObject('TC.02_Personal/Detail/Document Checklist/data/Address/popUpZipCode/txtZipCode'), '11480')

WebUI.click(findTestObject('TC.02_Personal/Detail/Document Checklist/data/Address/popUpZipCode/btnSearch'))
...
WebUI.click(findTestObject('TC.02_Personal/Detail/Document Checklist/data/Address/popUpZipCode/SpanFoundFirst'))

WebUI.click(findTestObject('TC.02_Personal/Detail/Document Checklist/data/Address/popUpZipCode/btnChoose'))

WebUI.delay(1)

WebUI.takeScreenshot(FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('TC.02_Personal/Detail/Document Checklist/data/Address/btnNext'))
