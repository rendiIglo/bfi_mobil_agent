...
WebUI.click(findTestObject('TC.02_MarketingVisitTask/a_NextPage'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.02_MarketingVisitTask/a_PreviousPage'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.02_MarketingVisitTask/a_LastPage'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.02_MarketingVisitTask/a_FirstPage'))

WebUI.delay(1)

WebUI.sendKeys(findTestObject('TC.02_MarketingVisitTask/input_pagingtxtbox'), Keys.chord(Keys.BACK_SPACE))

WebUI.setText(findTestObject('TC.02_MarketingVisitTask/input_pagingtxtbox'), '2')

WebUI.sendKeys(findTestObject('TC.02_MarketingVisitTask/input_pagingtxtbox'), Keys.chord(Keys.ENTER))
