...
WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/LeadDetail/btnBackButton'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Address/btnBack'))
