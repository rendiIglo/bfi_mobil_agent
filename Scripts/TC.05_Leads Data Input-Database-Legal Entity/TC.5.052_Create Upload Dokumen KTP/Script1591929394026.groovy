...
WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/PopupUpload/txtReceivedBy'), '-')

WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/PopupUpload/txtExpiredDate'), '12/12/2019')

not_run: WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/PopupUpload/a_FileDeleteButton'))

WebUI.click(findTestObject('TC.05_Leads Data Input-Database-LE/a_UploadIconKTP'))
