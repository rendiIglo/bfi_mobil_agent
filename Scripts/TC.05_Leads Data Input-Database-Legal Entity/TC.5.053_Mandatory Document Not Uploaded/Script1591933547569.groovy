...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/span_found_KK'))
...
CustomKeywords.'rendi.uploadNativePopUpWindow.uploadFile'(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/PopupUpload/a_UploadIcon'), 
    'E:\\my Documents\\ekreasi\\internal project\\Katalon\\leads-data-input-le\\KK.png')
