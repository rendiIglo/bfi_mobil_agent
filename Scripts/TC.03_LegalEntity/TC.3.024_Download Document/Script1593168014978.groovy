...
WebUI.click(findTestObject('TC.02_Personal/Detail/Document Checklist/SpanFoundSecond'))

WebUI.click(findTestObject('TC.02_Personal/Detail/Document Checklist/btnUpload'))
...
WebUI.setText(findTestObject('TC.02_Personal/Detail/Document Checklist/UploadDoc/txtReceivedBy'), 'Rendi')

WebUI.setText(findTestObject('TC.02_Personal/Detail/Document Checklist/UploadDoc/txtExpiredDate'), '20/02/2025')

WebUI.setText(findTestObject('TC.02_Personal/Detail/Document Checklist/UploadDoc/txtDocNo'), '001')

WebUI.click(findTestObject('TC.02_Personal/Detail/Document Checklist/UploadDoc/btnUploadImage'))

CustomKeywords.'rendi.uploadNativePopUpWindow.uploadFile'(findTestObject('TC.02_Personal/Detail/Document Checklist/UploadDoc/btnUploadImage'), 
    'E:\\my Documents\\ekreasi\\internal project\\Katalon\\ndf-car-adminver\\fotodenganrumah.jpg')

WebUI.waitForElementNotPresent(findTestObject('TC.02_Personal/Detail/Document Checklist/UploadDoc/divUploadStatus'), 0)

WebUI.delay(3)

WebUI.click(findTestObject('TC.02_Personal/Detail/Document Checklist/UploadDoc/btnSave'))
...
WebUI.click(findTestObject('TC.02_Personal/Detail/Document Checklist/btnView'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.02_Personal/Detail/Document Checklist/btnDownload'), FailureHandling.STOP_ON_FAILURE)
