...
WebUI.click(findTestObject('TC.02_Personal/Detail/Document Checklist/data/Address/popUpZipCode/SpanSortZipCode'))
...
WebUI.click(findTestObject('TC.02_Personal/Detail/Document Checklist/data/Address/popUpZipCode/SpanSortKelurahan'))
...
WebUI.click(findTestObject('TC.02_Personal/Detail/Document Checklist/data/Address/popUpZipCode/SpanSortKecamatan'))
...
WebUI.click(findTestObject('TC.02_Personal/Detail/Document Checklist/data/Address/popUpZipCode/SpanSortCity'))
