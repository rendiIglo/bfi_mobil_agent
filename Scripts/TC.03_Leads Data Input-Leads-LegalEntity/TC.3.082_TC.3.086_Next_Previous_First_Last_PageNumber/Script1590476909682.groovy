...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/popUpReferal/a_NextPage'))
...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/popUpReferal/a_PreviousPage'))
...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/popUpReferal/a_LastPage'))
...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/popUpReferal/a_FirstPage'))
...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/popUpReferal/input_pagingtxtbox'))

WebUI.sendKeys(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/popUpReferal/input_pagingtxtbox'), 
