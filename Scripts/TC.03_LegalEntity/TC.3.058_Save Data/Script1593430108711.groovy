...
WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Customer/chkUnmatchNPWP'))

WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Customer/chkUnmatchCustomerName'))

WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Customer/chkUnmatchPhone'))

WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Customer/chkUnmatchMobilePhone'))

WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Customer/chkUnmatchEmail'))

WebUI.delay(1)

WebUI.setText(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Customer/txtNPWP'), '654323456876543')

WebUI.setText(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Customer/txtCustomerName'), 'Basiruns')

WebUI.setText(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Customer/txtPhoneArea'), '021')

WebUI.setText(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Customer/txtPhone'), '8765434567')

WebUI.setText(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Customer/txtMobilePhone'), '0854323456784')

WebUI.setText(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Customer/txtEmail'), 'sylvia@dev-ad.co.id')
...
WebUI.setText(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Address/txtAddress'), 'Jl Anggreks')

WebUI.takeScreenshot(FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/divLeadDetail'))

WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/LeadDetail/btnSave'))
