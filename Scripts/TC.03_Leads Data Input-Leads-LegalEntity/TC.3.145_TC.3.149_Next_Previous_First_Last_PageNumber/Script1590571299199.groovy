...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/colletaralInfoTab/Add Colletaral Detail/Supplier/a_NextPage'))

WebUI.delay(2)

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/colletaralInfoTab/Add Colletaral Detail/Supplier/a_PreviousPage'))

WebUI.delay(2)

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/colletaralInfoTab/Add Colletaral Detail/Supplier/a_LastPage'))

WebUI.delay(2)

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/colletaralInfoTab/Add Colletaral Detail/Supplier/a_FirstPage'))

WebUI.delay(2)

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/colletaralInfoTab/Add Colletaral Detail/Supplier/input_pagingtxtbox'))

WebUI.sendKeys(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/colletaralInfoTab/Add Colletaral Detail/Supplier/input_pagingtxtbox'), 
