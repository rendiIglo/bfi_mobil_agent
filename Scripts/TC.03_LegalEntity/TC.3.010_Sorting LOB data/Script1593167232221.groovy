...
WebUI.click(findTestObject('TC.02_Personal/spanSortLeadsID'))
...
WebUI.click(findTestObject('TC.02_Personal/spanSortLeadsName'))
...
WebUI.click(findTestObject('TC.02_Personal/spanSortLeadsDate'))
...
WebUI.click(findTestObject('TC.02_Personal/spanSortUserInputLeads'))
