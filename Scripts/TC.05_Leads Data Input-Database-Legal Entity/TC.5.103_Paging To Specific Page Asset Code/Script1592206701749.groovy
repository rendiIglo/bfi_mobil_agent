...
WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-Personal/Leads Info/Address/txtAddress'), 'Perumahan Kota Harapan Indah, jl. Taman Heliconia Blok A no. 01')
...
WebUI.click(findTestObject('TC.05_Leads Data Input-Database-LE/a_addRowTC05'))
...
WebUI.setText(findTestObject('TC.05_Leads Data Input-Database-LE/txtProductionYear'), '2011')

WebUI.setText(findTestObject('TC.05_Leads Data Input-Database-LE/txtLicensePlate'), 'B 1454 NE')

WebUI.delay(1)

WebUI.click(findTestObject('TC.05_Leads Data Input-Database-LE/a_AssetCode'))
...
WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/colletaralInfoTab/Add Colletaral Detail/Supplier/input_pagingtxtbox'), 
    '2')
