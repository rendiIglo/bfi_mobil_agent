...
WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Address/PopUpZIPCode/txtKelurahan'), 'pusaka rakyat')

WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Address/PopUpZIPCode/txtCity'), 'bekasi')

WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Address/PopUpZIPCode/txtKecamatan'), 'tarumajaya')
