...
WebUI.setText(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Customer/txtCustomerName'), 'Basirun')
...
WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/Customer/btnNext'))
