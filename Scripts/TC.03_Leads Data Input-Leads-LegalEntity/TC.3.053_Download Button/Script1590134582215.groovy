...
WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/PopupUpload/txtReceivedBy'), 'Rexy')

WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/PopupUpload/txtExpiredDate'), '12/12/2020')

not_run: WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/PopupUpload/a_FileDeleteButton'))
...
CustomKeywords.'rendi.uploadNativePopUpWindow.uploadFile'(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/PopupUpload/a_UploadIcon'), 
    'E:\\my Documents\\ekreasi\\internal project\\Katalon\\leads-data-input-legal-entity\\NPWP.jpg')
...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/a_PreviewButton'))

WebUI.delay(1)

WebUI.scrollToPosition(0, 3000)

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/a_DownloadButton'))
