...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Customer/PopUpCopyLeadsID/a_NextPage'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Customer/PopUpCopyLeadsID/a_PreviousPage'))
...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Customer/PopUpCopyLeadsID/a_FirstPage'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Customer/PopUpCopyLeadsID/input_pagingtxtbox'))

WebUI.sendKeys(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Customer/PopUpCopyLeadsID/input_pagingtxtbox'), 
