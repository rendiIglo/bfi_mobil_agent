...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/a_PreviousPage'))

WebUI.delay(2)

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/a_LastPage'))

WebUI.delay(2)

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/a_FirstPage'))

WebUI.delay(2)

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/input_pagingtxtbox'))

WebUI.sendKeys(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/input_pagingtxtbox'), Keys.chord(
        Keys.CONTROL, 'a'))
