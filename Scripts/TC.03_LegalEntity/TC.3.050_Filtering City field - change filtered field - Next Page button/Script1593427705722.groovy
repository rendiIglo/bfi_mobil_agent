...
WebUI.setText(findTestObject('TC.02_Personal/Detail/Document Checklist/data/Address/popUpZipCode/txtCity'), 'Kota medan')
...
WebUI.setText(findTestObject('TC.02_Personal/Detail/Document Checklist/data/Address/popUpZipCode/txtCity'), 'Solo')
