...
WebUI.setText(findTestObject('TC.02_MarketingVisitTask/popup schedule marketing visit/txtVisitDate'), '30-Des-2020')

WebUI.setText(findTestObject('TC.02_MarketingVisitTask/popup schedule marketing visit/txtVisitHour'), '10:00')

not_run: WebUI.click(findTestObject('TC.02_MarketingVisitTask/popup schedule marketing visit/ddl_present'))

not_run: WebUI.click(findTestObject('TC.02_MarketingVisitTask/popup schedule marketing visit/span_ddlPresent_UnPresent'))

not_run: WebUI.click(findTestObject('TC.02_MarketingVisitTask/popup schedule marketing visit/ddl_result'))

not_run: WebUI.click(findTestObject('TC.02_MarketingVisitTask/popup schedule marketing visit/span_ddlResult_UnPresent_tidak bertemu'))

not_run: WebUI.click(findTestObject('TC.02_MarketingVisitTask/popup schedule marketing visit/a_nextButton'))

WebUI.setText(findTestObject('TC.02_MarketingVisitTask/popup schedule marketing visit/txtarea_notes'), 'Notes')
