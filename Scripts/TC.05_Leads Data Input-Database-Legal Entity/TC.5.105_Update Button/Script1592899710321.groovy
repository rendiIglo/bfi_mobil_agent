...
WebUI.click(findTestObject('TC.05_Leads Data Input-Database-LE/span_FoundFirstData_ColletaralInfoTab'))

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/colletaralInfoTab/a_Update'))
