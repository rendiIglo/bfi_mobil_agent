...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/span_found_ektp'))

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/a_UploadButton'))

WebUI.delay(1)

WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/PopupUpload/txtDocNo'), '25')

WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/PopupUpload/txtReceivedBy'), 'null')

WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/PopupUpload/txtExpiredDate'), '12/12/2020')
...
CustomKeywords.'rendi.uploadNativePopUpWindow.uploadFile'(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/PopupUpload/a_UploadIcon'), 
    'E:\\my Documents\\ekreasi\\internal project\\Katalon\\leads-data-input-le\\KTP.png')
...
CustomKeywords.'rendi.uploadNativePopUpWindow.uploadFile'(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/PopupUpload/a_UploadIcon'), 
    'E:\\my Documents\\ekreasi\\internal project\\Katalon\\leads-data-input-le\\npwp.jpg')
...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/a_NextPage'))
...
WebUI.focus(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/span_found_title_documentchecklist'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/span_found_SIM'))
...
CustomKeywords.'rendi.uploadNativePopUpWindow.uploadFile'(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/PopupUpload/a_UploadIcon'), 
    'E:\\my Documents\\ekreasi\\internal project\\Katalon\\leads-data-input-le\\sim.jpg')
...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/span_found_STNKBPKBMobil'))
...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Document/a_SaveButton'))
...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/span_ddlActivity_Employee Get Customer'))
...
WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/popUpReferal/txtBranchID'), '401')

not_run: WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/popUpReferal/txtEmployeeID'), 
    'adisf401')

not_run: WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/popUpReferal/txtEmployeeName'), 
    'Adi')
...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/colletaralInfoTab/Add Colletaral Detail/span_ddlBPKPBehalf_Sendiri'))

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/colletaralInfoTab/Add Colletaral Detail/RadioRentalYes'))
...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/colletaralInfoTab/Add Colletaral Detail/ddlSifatKreditItem/span_ddlSifatKredit_New-RO-Take Over'))
...
WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/colletaralInfoTab/Add Colletaral Detail/Asset/txtAssetDescription'), 
    'TOYOTA-ALL NEW AVANZA-VVTI E 1.3 AT')
...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/colletaralInfoTab/Add Colletaral Detail/span_ddlFirstInstallment_Advance'))
...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/colletaralInfoTab/Add Colletaral Detail/span_ddlinsuranceType_All Risk'))
