...
not_run: WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/colletaralInfoTab/Add Colletaral Detail/ProductOffering/txtProductOfferingID'), 
    '20010917L3')

WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/colletaralInfoTab/Add Colletaral Detail/ProductOffering/txtProductID'), 
    '2001')

not_run: WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/colletaralInfoTab/Add Colletaral Detail/ProductOffering/txtDescription'), 
    'NDF CAR Non MPU – Paket BFI Corporate – Sedan/Jeep/Minibus')
