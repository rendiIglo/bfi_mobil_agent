...
WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/popUpReferal/txtCustomerID'), 
    '123')

not_run: WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Lead Detail/popUpReferal/txtCustomerName'), 
    'dewi')
