...
WebUI.setText(findTestObject('TC.02_MarketingVisitTask/txtCustomerName'), 'Senecca')
...
WebUI.doubleClick(findTestObject('TC.02_MarketingVisitTask/span_Found_Senecca'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.02_MarketingVisitTask/popup schedule marketing visit/span_Sort_Visit_Schedule_Date'))

WebUI.click(findTestObject('TC.02_MarketingVisitTask/popup schedule marketing visit/span_Sort_Visit_Schedule_Time'))

WebUI.click(findTestObject('TC.02_MarketingVisitTask/popup schedule marketing visit/span_Sort_Note'))
