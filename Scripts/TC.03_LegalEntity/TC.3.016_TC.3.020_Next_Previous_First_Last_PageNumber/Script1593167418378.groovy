...
WebUI.click(findTestObject('TC.02_Personal/btnPrevious'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.02_Personal/btnLastPage'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.02_Personal/btnFirstPage'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.02_Personal/txtPagingNo'))

WebUI.sendKeys(findTestObject('TC.02_Personal/txtPagingNo'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('TC.02_Personal/txtPagingNo'), '3')

WebUI.sendKeys(findTestObject('TC.02_Personal/txtPagingNo'), Keys.chord(Keys.TAB))
