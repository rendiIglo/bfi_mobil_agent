...
WebUI.setText(findTestObject('TC.02_Personal/txtLeadsDateFrom'), '01/01/2020')

WebUI.setText(findTestObject('TC.02_Personal/txtLeadsDateTo'), '20/06/2020')

WebUI.click(findTestObject('TC.02_Personal/btnSearch'))

WebUI.waitForElementPresent(findTestObject('TC.02_Personal/divLoadSearch'), 0)

WebUI.waitForElementNotPresent(findTestObject('TC.02_Personal/divLoadSearch'), 0)

WebUI.delay(1)

WebUI.setText(findTestObject('TC.02_Personal/txtLeadsDateTo'), '20/12/2020')

WebUI.setText(findTestObject('TC.02_Personal/txtLeadsDateFrom'), '01/07/2020')

WebUI.click(findTestObject('TC.02_Personal/btnNext'))
