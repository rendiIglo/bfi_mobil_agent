...
WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Customer/PopUpCopyLeadsID/txtLeadsID'), '000224')

WebUI.setText(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Customer/PopUpCopyLeadsID/txtLeadsName'), 
    'Belawan')

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Customer/PopUpCopyLeadsID/a_SearchButton'))

WebUI.delay(1)

WebUI.waitForElementNotPresent(findTestObject('Master/divLoading'), 10)

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Customer/PopUpCopyLeadsID/span_found_FirstData'))

WebUI.delay(3)

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Customer/PopUpCopyLeadsID/a_ChooseButton'))
...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Customer/PopUpDuplicate/span_Found_FirstData'))

not_run: WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-LE/Leads Info/Customer/PopUpDuplicate/a_ChooseButton'))
