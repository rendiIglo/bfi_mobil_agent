...
WebUI.setText(findTestObject('TC.02_MarketingVisitTask/txtCustomerName'), 'Rifka')

WebUI.setText(findTestObject('TC.02_MarketingVisitTask/txtLeadsID'), '20200415-401-L-000145')

WebUI.setText(findTestObject('TC.02_MarketingVisitTask/txtCustomerID'), '')

WebUI.setText(findTestObject('TC.02_MarketingVisitTask/txtAssignmentDateFrom'), '1-Apr-2020')

WebUI.setText(findTestObject('TC.02_MarketingVisitTask/txtAssignmentDateTo'), '1-Mei-2020')
