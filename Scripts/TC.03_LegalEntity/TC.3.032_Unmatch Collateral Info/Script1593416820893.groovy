...
WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/LeadDetail/SpanFoundFirst'))

WebUI.click(findTestObject('TC.03_LegalEntity/Detail/DocChecklist/LeadDetail/btnUnMatch'))

WebUI.delay(3)

WebUI.scrollToElement(findTestObject('TC.02_Personal/Detail/Document Checklist/data/LeadDetail/SpanScrollColletaralInfo'), 
    0)
