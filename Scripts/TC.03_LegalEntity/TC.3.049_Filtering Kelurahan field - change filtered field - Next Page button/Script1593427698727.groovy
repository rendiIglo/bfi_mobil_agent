...
WebUI.setText(findTestObject('TC.02_Personal/Detail/Document Checklist/data/Address/popUpZipCode/txtKelurahan'), 'Sidumulyo')
...
WebUI.setText(findTestObject('TC.02_Personal/Detail/Document Checklist/data/Address/popUpZipCode/txtKelurahan'), 'medan satria')
